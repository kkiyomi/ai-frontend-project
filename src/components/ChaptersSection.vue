    ...
    <div class="flex-1 overflow-y-auto">
        ...
        <div class="p-4">
            ...
            <div v-else class="space-y-4">
                <div v-for="seriesItem in series" :key="seriesItem.id" class="border border-gray-200 rounded-lg overflow-hidden">
                    <!-- Series Header -->
                    <div class="bg-gray-50 p-3 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="flex-1 min-w-0">
                                ...
                                <p v-if="seriesItem.description" class="text-xs text-gray-500 mt-1">{{ seriesItem.description }}</p>
