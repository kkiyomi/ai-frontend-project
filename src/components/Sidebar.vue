<template>
  ...
  >
    ...
    <div
      v-if="!isExpanded"
      class="flex flex-col items-center py-4 space-y-4 flex-shrink-0"
    >
      <!-- Main Icon -->
      <div
        ...
        <div class="p-4 flex-shrink-0">
          ...
          <div v-if="isUploading" class="mt-3">
            <div class="bg-gray-200 rounded-full h-2">
              <div
                class="bg-blue-600 h-2 rounded-full transition-all duration-300 w-1/2"
              ></div>
            </div>
            ...
            >
              <div class="flex items-start justify-between">
                <div class="flex-1 min-w-0">
                  ...
                  >
                    <span
                      >{{ getTranslationProgress(chapter) }}% translated</span
                    >
...
const { chapters, currentChapterId, addChapter, selectChapter, removeChapter } =
  useChapters();
